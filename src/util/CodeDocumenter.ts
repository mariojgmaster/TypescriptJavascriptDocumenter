...
export default class EvilGitMerge {
    ...
    public formataData(valorDateTime: Date, type: String) {
        let retorno
        if (type == 'time') {
...
**/\n`)
    ...
    public replace() {
        ...
        editor.document.languageId != 'typescriptreact') { return; }
        else {
            ...
            if (alreadyChanged_check1 && alreadyChanged_check2 && alreadyChanged_check3 && alreadyChanged_check4 && alreadyChanged_check5) return;
